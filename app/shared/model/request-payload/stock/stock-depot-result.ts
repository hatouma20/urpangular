...
export class StockDepotResultForm {
  constructor(
    ...
    public reference: { dirty: boolean; error: string; value: string; class: string },
    public status: { dirty: boolean; error: string; value: string; class: string },
