...
@Component({
  selector: 'wind-traite-payment',
  templateUrl: './traite-payment.component.html',
  styleUrls: ['traite-payment.component.css', '../../../../../assets/css/mystyle.css']
})
export class TraitePaymentComponent implements OnInit {
